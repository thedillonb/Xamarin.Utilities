    ...
    public class LoadMoreElement : OwnerDrawnElement
	{
		...
		void Layout (UITableViewCell cell, UIActivityIndicatorView activityIndicator, UILabel caption)
		{
			...
			if (!activityIndicator.Hidden)
                activityIndicator.Frame = new RectangleF ((sbounds.Width-size.Width)/2-IndicatorSize*2, Padding, IndicatorSize, IndicatorSize);

            caption.Frame = new RectangleF (10, Padding, sbounds.Width-20, size.Height);
		}
